 ...
 */
@Portable @Bindable
public class PortableSpeaker implements PortableObject {
  ...
  private static final long serialVersionUID = -1973712869193247386L;
	 ...
	 */
  public PortableSpeaker(String objectId, String name, String description) {
    this();
  ...
  public boolean equals(Object obj) {
  	...
  	if (obj instanceof PortableSpeaker) return false;
  	PortableSpeaker that = (PortableSpeaker) obj;
	  return (
